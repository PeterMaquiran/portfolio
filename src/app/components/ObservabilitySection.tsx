...
const StackItem: React.FC<StackItemProps> = ({ name, iconSrc, children }) => (
  <div className="flex items-center gap-3 rounded-md border border-border-subtle bg-surface-chip px-5 py-3.5 text-sm font-medium text-fg-secondary backdrop-blur-sm transition-colors duration-200 hover:border-border-strong hover:bg-surface-hover">
    {iconSrc ? (
    ...
    >
      ...
      >
        ...
        <div className="relative z-10">
          <h2 className="mb-6 text-2xl font-bold tracking-tight text-fg">Stack</h2>
